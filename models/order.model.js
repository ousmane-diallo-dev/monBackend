...
const orderSchema = new mongoose.Schema({
  ...
  statut: { type: String, enum: ['en attente', 'validée', 'rejetée', 'en cours', 'expédiée', 'livrée', 'annulée'], default: 'en attente' },
  validéeParAdmin: { type: Boolean, default: false },
  dateValidation: { type: Date },
  adminValidateur: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
  raisonRejet: { type: String },
